                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Bayani Adam Sasaki</div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Riko Adi Ranasmita</div>
                                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                            Nulla vel metus scelerisque ante sollicitudin.</span>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Yosia Neveriska</div>
                                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                            Nulla vel metus scelerisque ante sollicitudin.</span>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Gede Sinom Syahadat</div>
                                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                            Nulla vel metus scelerisque ante sollicitudin.</span>
                                    </div>
                                </li>
